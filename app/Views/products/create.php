            ...
            <form action="<?= base_url('products/store') ?>" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="number" step="0.01" name="price" class="form-control bg-light border-0 py-2" placeholder="0.00" value="<?= old('price') ?>">
                    </div>
                    <div class="col-md-6 mb-4">
                        <label class="form-label fw-semibold">Stock Quantity</label>
                        <input type="number" name="stock" class="form-control bg-light border-0 py-2" placeholder="0" value="<?= old('stock') ?>">
                    </div>
                </div>
